!(function(l) {
	l.fn.animatedModal = function(a) {
			...
			o = l.extend(
				{
					...
					top: "300vh",
					left: "0px",
					zIndexIn: "9999999999999999999",
					zIndexOut: "-9999999999999999999",
					color: "#39BEB9",
					opacityIn: "1",
					opacityOut: "0",
					animatedIn: "zoomIn",
		...
		function s() {
			e.css({ "z-index": o.zIndexOut }), o.afterClose();
		}
		function m() {
			o.afterOpen();
		}
		e.css(r),
			n.click(function(a) {
				a.preventDefault(),
					...
					i == d &&
						(e.hasClass(o.modalTarget + "-off") &&
							(e.removeClass(o.animatedOut),
							e.removeClass(o.modalTarget + "-off"),
							e.addClass(o.modalTarget + "-on")),
						e.hasClass(o.modalTarget + "-on") &&
							(o.beforeOpen(),
							e.css({
								opacity: o.opacityIn,
								"z-index": o.zIndexIn
			...
			t.click(function(a) {
				a.preventDefault(),
					...
					o.beforeClose(),
					e.hasClass(o.modalTarget + "-on") &&
						(e.removeClass(o.modalTarget + "-on"),
						e.addClass(o.modalTarget + "-off")),
					e.hasClass(o.modalTarget + "-off") &&
						(e.removeClass(o.animatedIn),
